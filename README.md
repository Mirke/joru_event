...
6. Now you can either double click on app.py or move in terminal to folder and run "py app.py"
...
* blacklist.txt counts out the users in the JSON files.
* saved_words.txt contains the saved words as a save option.
